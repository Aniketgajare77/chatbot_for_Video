...
def extract_transcript_details(youtube_video_url):
    try:
        video_id = youtube_video_url.split("=")[-1]  # Get the last element after splitting by "="
...
# App title
st.title("ConverseAI - Your Intelligent Chat Companion")
...
with col1:
    ...
    if youtube_link:
        video_id = youtube_link.split("=")[-1]  # Get the last element after splitting by "="
...
with col2:
    if youtube_link:
        ...
        # Chat section
        st.header("Welcome to ConverseAI")
